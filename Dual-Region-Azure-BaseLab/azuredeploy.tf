...
resource "azurerm_virtual_machine_extension" "region1-dc01-basesetup" {
  ...
  settings = <<SETTINGS
    {
        "fileUris": [
          "https://raw.githubusercontent.com/cloudjitsu/Terraform-Azure/main/Dual-Region-Azure-BaseLab/PowerShell/DC1/baselab_DCSetup1.ps1"
        ]
    }
  SETTINGS
}
...
resource "azurerm_virtual_machine_extension" "region2-dc01-basesetup" {
  ...
  settings = <<SETTINGS
    {
        "fileUris": [
          "https://raw.githubusercontent.com/cloudjitsu/Terraform-Azure/main/Dual-Region-Azure-BaseLab/PowerShell/DC2/baselab_DCSetup2.ps1"
        ]
    }
  SETTINGS
}