...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/cloudjitsu/Terraform-Azure/main/Single-Region-Azure-BaseLab-with-Ansible/PowerShell/baselab_DomainSetup.ps1" -OutFile "C:\BaselabSetup\baselab_DomainSetup.ps1"
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/cloudjitsu/Terraform-Azure/main/Single-Region-Azure-BaseLab-with-Ansible/PowerShell/baselab_LabStructure.ps1" -OutFile "C:\BaselabSetup\baselab_LabStructure.ps1"
